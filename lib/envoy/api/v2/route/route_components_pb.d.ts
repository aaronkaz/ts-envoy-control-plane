...
// file: envoy/api/v2/route/route_components.proto
...
export class RouteAction extends jspb.Message { 
    ...
    getRegexRewrite(): envoy_type_matcher_regex_pb.RegexMatchAndSubstitute | undefined;
    setRegexRewrite(value?: envoy_type_matcher_regex_pb.RegexMatchAndSubstitute): void;
...
export namespace RouteAction {
    export type AsObject = {
        ...
        regexRewrite?: envoy_type_matcher_regex_pb.RegexMatchAndSubstitute.AsObject,
        hostRewrite: string,
