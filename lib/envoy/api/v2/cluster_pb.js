...
proto.envoy.api.v2.Cluster.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tlsContext: (f = msg.getTlsContext()) && envoy_api_v2_auth_tls_pb.UpstreamTlsContext.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new envoy_api_v2_auth_tls_pb.UpstreamTlsContext;
      reader.readMessage(value,envoy_api_v2_auth_tls_pb.UpstreamTlsContext.deserializeBinaryFromReader);
...
proto.envoy.api.v2.Cluster.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      envoy_api_v2_auth_tls_pb.UpstreamTlsContext.serializeBinaryToWriter
    );
  }
...
proto.envoy.api.v2.Cluster.prototype.getTlsContext = function() {
  return /** @type{?proto.envoy.api.v2.auth.UpstreamTlsContext} */ (
    jspb.Message.getWrapperField(this, envoy_api_v2_auth_tls_pb.UpstreamTlsContext, 11));
};
