...
import * as envoy_api_v2_core_event_service_config_pb from "../../../../envoy/api/v2/core/event_service_config_pb";
...
export class HealthCheck extends jspb.Message { 
    ...
    getEventService(): envoy_api_v2_core_event_service_config_pb.EventServiceConfig | undefined;
    setEventService(value?: envoy_api_v2_core_event_service_config_pb.EventServiceConfig): void;
...
export namespace HealthCheck {
    export type AsObject = {
        ...
        eventLogPath: string,
        eventService?: envoy_api_v2_core_event_service_config_pb.EventServiceConfig.AsObject,
    ...
    export class HttpHealthCheck extends jspb.Message { 
        ...
        getServiceNameMatcher(): envoy_type_matcher_string_pb.StringMatcher | undefined;
        setServiceNameMatcher(value?: envoy_type_matcher_string_pb.StringMatcher): void;
    ...
    export namespace HttpHealthCheck {
        export type AsObject = {
            ...
            serviceNameMatcher?: envoy_type_matcher_string_pb.StringMatcher.AsObject,
        }
    }
