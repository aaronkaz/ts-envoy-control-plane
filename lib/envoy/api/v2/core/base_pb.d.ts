...
import * as envoy_api_v2_core_backoff_pb from "../../../../envoy/api/v2/core/backoff_pb";
...
import * as envoy_type_semantic_version_pb from "../../../../envoy/type/semantic_version_pb";
...
export class BuildVersion extends jspb.Message { 
    ...
    hasVersion(): boolean;
    clearVersion(): void;
    getVersion(): envoy_type_semantic_version_pb.SemanticVersion | undefined;
    setVersion(value?: envoy_type_semantic_version_pb.SemanticVersion): void;
...
export namespace BuildVersion {
    export type AsObject = {
        version?: envoy_type_semantic_version_pb.SemanticVersion.AsObject,
...
export class Node extends jspb.Message { 
    ...
    getListeningAddressesList(): Array<envoy_api_v2_core_address_pb.Address>;
    setListeningAddressesList(value: Array<envoy_api_v2_core_address_pb.Address>): void;
    addListeningAddresses(value?: envoy_api_v2_core_address_pb.Address, index?: number): envoy_api_v2_core_address_pb.Address;
...
export namespace Node {
    export type AsObject = {
        ...
        listeningAddressesList: Array<envoy_api_v2_core_address_pb.Address.AsObject>,
    }
...
export class RetryPolicy extends jspb.Message { 
    ...
    getRetryBackOff(): envoy_api_v2_core_backoff_pb.BackoffStrategy | undefined;
    setRetryBackOff(value?: envoy_api_v2_core_backoff_pb.BackoffStrategy): void;
...
export namespace RetryPolicy {
    export type AsObject = {
        retryBackOff?: envoy_api_v2_core_backoff_pb.BackoffStrategy.AsObject,
