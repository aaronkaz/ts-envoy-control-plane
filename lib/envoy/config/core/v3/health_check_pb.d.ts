...
// file: envoy/config/core/v3/health_check.proto
...
import * as envoy_config_core_v3_event_service_config_pb from "../../../../envoy/config/core/v3/event_service_config_pb";
import * as envoy_type_matcher_v3_string_pb from "../../../../envoy/type/matcher/v3/string_pb";
import * as envoy_type_v3_http_pb from "../../../../envoy/type/v3/http_pb";
import * as envoy_type_v3_range_pb from "../../../../envoy/type/v3/range_pb";
...
export class HealthCheck extends jspb.Message { 
    ...
    hasNoTrafficHealthyInterval(): boolean;
    clearNoTrafficHealthyInterval(): void;
    getNoTrafficHealthyInterval(): google_protobuf_duration_pb.Duration | undefined;
    setNoTrafficHealthyInterval(value?: google_protobuf_duration_pb.Duration): void;
    ...
    getEventService(): envoy_config_core_v3_event_service_config_pb.EventServiceConfig | undefined;
    setEventService(value?: envoy_config_core_v3_event_service_config_pb.EventServiceConfig): void;
...
export namespace HealthCheck {
    export type AsObject = {
        ...
        noTrafficHealthyInterval?: google_protobuf_duration_pb.Duration.AsObject,
        ...
        eventLogPath: string,
        eventService?: envoy_config_core_v3_event_service_config_pb.EventServiceConfig.AsObject,
    ...
    export class HttpHealthCheck extends jspb.Message { 
        ...
        getRequestHeadersToAddList(): Array<envoy_config_core_v3_base_pb.HeaderValueOption>;
        setRequestHeadersToAddList(value: Array<envoy_config_core_v3_base_pb.HeaderValueOption>): void;
        addRequestHeadersToAdd(value?: envoy_config_core_v3_base_pb.HeaderValueOption, index?: number): envoy_config_core_v3_base_pb.HeaderValueOption;
        ...
        getExpectedStatusesList(): Array<envoy_type_v3_range_pb.Int64Range>;
        setExpectedStatusesList(value: Array<envoy_type_v3_range_pb.Int64Range>): void;
        addExpectedStatuses(value?: envoy_type_v3_range_pb.Int64Range, index?: number): envoy_type_v3_range_pb.Int64Range;

        getCodecClientType(): envoy_type_v3_http_pb.CodecClientType;
        setCodecClientType(value: envoy_type_v3_http_pb.CodecClientType): void;


        hasServiceNameMatcher(): boolean;
        clearServiceNameMatcher(): void;
        getServiceNameMatcher(): envoy_type_matcher_v3_string_pb.StringMatcher | undefined;
        setServiceNameMatcher(value?: envoy_type_matcher_v3_string_pb.StringMatcher): void;
    ...
    export namespace HttpHealthCheck {
        export type AsObject = {
            ...
            requestHeadersToAddList: Array<envoy_config_core_v3_base_pb.HeaderValueOption.AsObject>,
            requestHeadersToRemoveList: Array<string>,
            expectedStatusesList: Array<envoy_type_v3_range_pb.Int64Range.AsObject>,
            codecClientType: envoy_type_v3_http_pb.CodecClientType,
            serviceNameMatcher?: envoy_type_matcher_v3_string_pb.StringMatcher.AsObject,
        }
    }
