...
// file: envoy/type/matcher/v3/path.proto
...
export class PathMatcher extends jspb.Message { 
    ...
    hasPath(): boolean;
    clearPath(): void;
    getPath(): envoy_type_matcher_v3_string_pb.StringMatcher | undefined;
    setPath(value?: envoy_type_matcher_v3_string_pb.StringMatcher): void;
...
export namespace PathMatcher {
    export type AsObject = {
        path?: envoy_type_matcher_v3_string_pb.StringMatcher.AsObject,
    }
