...
// file: envoy/type/matcher/v4alpha/number.proto
...
export class DoubleMatcher extends jspb.Message { 
    ...
    hasRange(): boolean;
    clearRange(): void;
    getRange(): envoy_type_v3_range_pb.DoubleRange | undefined;
    setRange(value?: envoy_type_v3_range_pb.DoubleRange): void;
...
export namespace DoubleMatcher {
    export type AsObject = {
        range?: envoy_type_v3_range_pb.DoubleRange.AsObject,
        exact: number,
    }
