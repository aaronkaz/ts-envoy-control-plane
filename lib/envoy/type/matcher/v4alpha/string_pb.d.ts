...
// file: envoy/type/matcher/v4alpha/string.proto

/* tslint:disable */
/* eslint-disable */

import * as jspb from "google-protobuf";
import * as envoy_type_matcher_v4alpha_regex_pb from "../../../../envoy/type/matcher/v4alpha/regex_pb";
...
export class StringMatcher extends jspb.Message { 
    ...
    clearSafeRegex(): void;
    getSafeRegex(): envoy_type_matcher_v4alpha_regex_pb.RegexMatcher | undefined;
    setSafeRegex(value?: envoy_type_matcher_v4alpha_regex_pb.RegexMatcher): void;
...
export namespace StringMatcher {
    export type AsObject = {
        ...
        prefix: string,
        suffix: string,
        safeRegex?: envoy_type_matcher_v4alpha_regex_pb.RegexMatcher.AsObject,
        contains: string,
        ignoreCase: boolean,
    }
