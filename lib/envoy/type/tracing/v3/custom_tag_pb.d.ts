...
// file: envoy/type/tracing/v3/custom_tag.proto

/* tslint:disable */
/* eslint-disable */

import * as jspb from "google-protobuf";
import * as envoy_type_metadata_v3_metadata_pb from "../../../../envoy/type/metadata/v3/metadata_pb";
...
export namespace CustomTag {
    ...
    export class Metadata extends jspb.Message { 
        ...
        hasKind(): boolean;
        clearKind(): void;
        getKind(): envoy_type_metadata_v3_metadata_pb.MetadataKind | undefined;
        setKind(value?: envoy_type_metadata_v3_metadata_pb.MetadataKind): void;


        hasMetadataKey(): boolean;
        clearMetadataKey(): void;
        getMetadataKey(): envoy_type_metadata_v3_metadata_pb.MetadataKey | undefined;
        setMetadataKey(value?: envoy_type_metadata_v3_metadata_pb.MetadataKey): void;
    ...
    export namespace Metadata {
        export type AsObject = {
            kind?: envoy_type_metadata_v3_metadata_pb.MetadataKind.AsObject,
            metadataKey?: envoy_type_metadata_v3_metadata_pb.MetadataKey.AsObject,
            defaultValue: string,
        }
    }
